    ...
    return <div className="flex flex-col w-screen font-serif justify-center items-center">
        ...
        <div className='grid grid-cols-3 gap-24 mt-16 items-start'>
            ...
            <div className='flex flex-col w-56 justify-center items-center'>
                ...
                <div className="text-xl text-gray-600 text-center my-4">As a heritage manager, I have worked with numerous crafts communties and designed program for the sustenance of traditional crafts</div>
            </div>
            <div className='flex flex-col w-56 justify-center items-center'>
                ...
                <div className="text-xl text-gray-600 text-center my-4">I have been a reciepient of an International Exchange Program in Germany. I had the opportunity to support educational interventions for refugee groups.</div>
            </div>
            <div className='flex flex-col w-56 justify-center items-center'>
                ...
                <div className="text-xl text-gray-600 text-center my-4">A rural internship in Jhiri village, Rajasthan has been a turning point in my life. Mnay surprises and learning, it has been an enriching experience.</div>
            </div>
        </div>
